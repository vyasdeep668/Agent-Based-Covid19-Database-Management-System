...
UserPageFrame = tk.Frame
class UserPage(UserPageFrame):
    #Callbacks Here
    def Button1_Callback(self, controller):
        print('UserPage Button 1 Pressed')
        #self.Message1.configure(text = "User Page Message v1")
        #controller.show_frame(UserPage.PageOne)

    def Button2_Callback(self, controller):
        print('UserPage Button 2 Pressed')
        # controller.show_frame(UserPage.PageOne)

    def Button3_Callback(self, controller):
        print('UserPage Button 3 Pressed')
    ...
    def Button4_Callback(self, controller):
        print('UserPage Button 4 Pressed')
    ...
    def Button5_Callback(self, controller):
        print('UserPage Button 5 Pressed')
    ...
    def __init__(self, parent, controller):
        ...
        self.Message1.configure(text="Welcome User")
        ...
        self.Button1.configure(command= lambda: UserPage.Button1_Callback(self, controller))
        ...
        self.Button2.configure(command=lambda: UserPage.Button2_Callback(self, controller))
        ...
        self.Button3.configure(command=lambda: UserPage.Button3_Callback(self, controller))
        ...
        self.Button4.configure(command=lambda: UserPage.Button4_Callback(self, controller))
        ...
        self.Button5.configure(command=lambda: UserPage.Button5_Callback(self, controller))
