...
class EditVaccineDataPage(EditVaccineDataPageFrame):
    ...
    def Button10_Callback(self, controller):
        ...
        ReceivedData = Webportal_Agent.RequestData(AgentCommunication.WebPortalAgentID,
                                                   ...
                                                   AgentCommunication.VaccineDataUpdateCommandID,
        ...
        if ReceivedData[AgentCommunication.ErrorCodeIndex] == AgentCommunication.DataNotFoundAckID:
            tkinter.messagebox.showerror(title="Error", message="Vaccine Data not found!")
            return
        ...
        if ReceivedData[AgentCommunication.ErrorCodeIndex] == AgentCommunication.DataUpdateFailedAckID:
            tkinter.messagebox.showerror(title="Error", message="Vaccine Data update failed!")
            return

        # No Error Found and User Update Success
        tkinter.messagebox.showinfo(title="Success", message="Vaccine Data Updated!")
    ...
    def Button11_Callback(self, controller):
        ...
        ReceivedData = Webportal_Agent.RequestData(AgentCommunication.WebPortalAgentID,
                                                   AgentCommunication.SystemDatabaseAgentID,
                                                   AgentCommunication.VaccineDataDeleteCommandID,
                                                   AgentCommunication.SuccessAckID,
                                                   CommData)
        ...
        if ReceivedData[AgentCommunication.ErrorCodeIndex] == AgentCommunication.DataDeleteFailedAckID:
            tkinter.messagebox.showerror(title="Error", message="Vaccine Data Delete failed!")
            return

        # No Error Found and User Update Success
        tkinter.messagebox.showinfo(title="Success", message="Vaccine Data Deleted!")
